"""
Django settings for rumbia project.
...
JWT_ALGORITHM = 'HS256'
JWT_ACCESS_TOKEN_LIFETIME = datetime.timedelta(hours=25)
...
WSGI_APPLICATION = 'rumbia.wsgi.application'
