...
class Session(models.Model):
    ...
    session_status = models.CharField(max_length=45)
    meeting_url = models.TextField(max_length=500, null=True, blank=True)
    meeting_platform = models.CharField(max_length=45)
    session_notes = models.TextField(max_length=250, null=True, blank=True)
...
class ProfessionalProfile(models.Model):
    ...
    work_experiences = models.JSONField(null=True, blank=True)
